#ifndef LLVM_LIB_TARGET_LVM_LVMMACHINEFUNCTIONINFO_H
#define LLVM_LIB_TARGET_LVM_LVMMACHINEFUNCTIONINFO_H
...
namespace llvm {
  // This class is derived from MachienFunction private LVM target-specific
  // information for each MachineFunction.
  class LVMMachineFunctionInfo : public MachineFunctionInfo {
  public:
    LVMMachineFunctionInfo(MachineFunction &MF)
        : MF(MF),
