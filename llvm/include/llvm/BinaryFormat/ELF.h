...
// LVM Specific e_flags
enum : unsigned {
  EF_LVM_NOREORDER = 0x00000001,  // Don't reorder instructions
  EF_LVM_PIC       = 0x00000002,  // Position independent code
  EF_LVM_ARCH_32   = 0x50000000,  // LVM32 instruction set per linux not elf.h
  EF_LVM_ARCH      = 0xf0000000,  // Mask for applying EF_LVM_ARCH_ variant
};

// ELF Relocation types for LVM

enum {
#include "ELFRelocs/LVM.def"
};
